...
#define _SCH_DEVICE_ID           0             ///< Device unique ID
#define SCH_SW_VERSION          "2.1.0"      ///< Software version
...
#define _SCH_COMM_ZMQ_OUT        "tcp://127.0.0.1:8002"  ///< Out socket URI
#define _SCH_COMM_ZMQ_IN         "tcp://127.0.0.1:8001"   ///< In socket URI
